package nyc.c4q.tarynking.calc;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonDivide.setText(fromHtml(Helpers.division));
        buttonSquareRoot.setText(fromHtml(Helpers.squareRoot));
        buttonXSquare.setText(fromHtml(Helpers.xSquare));
        buttonYPowerX.setText(fromHtml(Helpers.yPowerX));
        ...
        labelInverseSin.setText(fromHtml(Helpers.inverseSin));
        labelInverseCos.setText(fromHtml(Helpers.inverseCos));
        labelInverseTan.setText(fromHtml(Helpers.inverseTan));
        labelExponential.setText(fromHtml(Helpers.exponential));
        labelTenPowerX.setText(fromHtml(Helpers.tenPowerX));
        labelCubeRoot.setText(fromHtml(Helpers.cubeSquare));
        labelCube.setText(fromHtml(Helpers.cubeRoot));
        labelPi.setText(fromHtml(Helpers.pi));
